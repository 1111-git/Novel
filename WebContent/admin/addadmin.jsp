...
<% String message=(String) request.getAttribute("message"); if (message==null) { message="" ; } if
    (!message.trim().equals("")) { out.println("<script language='javascript'>");
    ...
    <body>
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr valign="top">
                <td bgcolor="#FFFFFF">
                    <form action="admin/addAdmin.action" name="myform">
                        <table width="40%" border="0" align="center" cellpadding="4" cellspacing="1"
                            bgcolor="#aec3de">
                            ...
                            <tr align="center" bgcolor="#F2FDFF">
                                ...
                                <td align="left"><input type="text" placeholder="请输入用户名" name="username"
                                        style="width: 160px" id="username" /></td>
                            </tr>
                            <tr align="center" bgcolor="#F2FDFF">
                                <td width="20%" align="right">密码</td>
                                <td align="left"><input type="password" placeholder="请输入密码" name="password"
                                        style="width: 160px" id="password" /></td>
                            </tr>
                            <tr align="center" bgcolor="#F2FDFF">
                                <td width="20%" align="right">姓名</td>
                                <td align="left"><input type="text" placeholder="请输入姓名" name="realname"
                                        style="width: 160px" id="realname" /></td>
                            </tr>
                            <tr align="center" bgcolor="#F2FDFF">
                                <td width="20%" align="right">联系方式</td>
                                <td align="left"><input type="text" placeholder="请输入联系方式" name="contact"
    ...
    <script>
        function checkpas() {
            ...
            var repas = document.myform.password2.value;
            if (pas != repas) {
                alert('两次密码不一致');
                return flase;
            }

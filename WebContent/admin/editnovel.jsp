...
%><body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr valign="top">
			<td bgcolor="#FFFFFF"><form action="novel/updateNovel.action" method="post"
					name="myform" onsubmit="return check()">
					<table width="60%" border="0" align="center" cellpadding="4"
						cellspacing="1" bgcolor="#aec3de">
						<tr align="center" bgcolor="#F2FDFF">
							<td align="left" colspan="2" class="optiontitle">修改小说
							<input type="hidden" name="novelid" value="${novel.novelid}" />
							<input type="hidden" name="addtime" value="${novel.addtime}" />
							<input type="hidden" name="hits" value="${novel.hits}" />
							</td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">小说名称</td>
							<td align="left"><input type="text" name="novelname"
								style="width: 160px" id="novelname" value="${novel.novelname}" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">封面</td>
							<td align="left"><input type="text" name="image"
								style="width: 160px" id="image" value="${novel.image}"
						...
						<tr align="center" bgcolor="#F2FDFF">
							...
							<td align="left"><input type="text" name="author"
								style="width: 160px" id="author" value="${novel.author}" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">小说介绍</td>
							<td align="left"><script type="text/javascript"
									src="ckeditor/ckeditor.js"></script> <textarea cols="80"
									name="contents" id="contents" rows="10">${novel.contents}</textarea>
								<script type="text/javascript">

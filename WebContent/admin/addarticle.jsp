 ...
 <% String message=(String) request.getAttribute("message"); if (message==null) { message="" ; } if
     ...
     <body>
         <table width="100%" border="0" cellpadding="0" cellspacing="0">
             <tr valign="top">
                 <td bgcolor="#FFFFFF">
                     <form action="article/addArticle.action" method="post" name="myform"
                         ...
                         <table width="60%" border="0" align="center" cellpadding="4" cellspacing="1"
                             ...
                             <tr align="center" bgcolor="#F2FDFF">
                                 ...
                                 <td align="left"><input type="text" placeholder="请输入标题" name="title"
                                         style="width: 160px" id="title" /></td>
                             </tr>
                             <tr align="center" bgcolor="#F2FDFF">
                                 <td width="20%" align="right">图片</td>
                                 <td align="left"><input type="text" placeholder="请选择图片" name="image"
                             ...
                             <tr align="center" bgcolor="#F2FDFF">
                                 ...
                                 <td align="left">
                                     ...
                                     <textarea cols="80" name="contents" id="contents"

		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="20" class="optiontitle">小说章节信息列表</td>
					</tr>
					<tr align="center">
					...
					<c:forEach items="${sectionsList}" var="sections">
						<tr align="center" bgcolor="#FFFFFF">
							<td align="center">${sections.title}</td>
							<td align="center">${sections.novelname}</td>
							<td align="center">${sections.addtime}</td>
							<td align="center">${sections.hits}</td>
						</tr>
					</c:forEach>
					<tr align="right" bgcolor="#ebf0f7">
						<td colspan="20"><form
								action="sections/querySectionsByCond.action" name="myform"
								method="post">
								查询条件<select name="cond" style="width: 100px"><option
										value="title">按标题查询</option>
									<option value="novelid">按小说查询</option>
									<option value="addtime">按上传日期查询</option>
									<option value="hits">按点击数查询</option>
									<option value="thepre">按上一章查询</option>
									<option value="thenext">按下一张查询</option></select>关键字<input type="text"

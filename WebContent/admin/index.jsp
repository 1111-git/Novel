					...
					<tr>
						<td vAlign=top bgColor=#ffffff>
							<table cellSpacing=0 cellPadding=0 width="100%" border=0>
								<tbody>
									<tr>
										<td width=480 background=images/login_top.jpg height=54 >
											<span class="bt">欢迎使用小说阅读网站管理系统</span>
											<!-- <a class="registA" href="<%=basePath%>admin/author.jsp">注册为作者</a> -->
										</td>
									</tr>
									<tr>
												...
												<tbody>
													<tr>
														<td align=middle width="40%">
															<IMG height=90 src="images/login.gif" width=91>
														</td>
														<td>
																...
																<tbody>
																	...
																	<tr align="center">
																		<td colSpan=2 height=40>
																			...
																			<input class="btn" type="reset" value="取 消" name="reset">
																		</td>
																	</tr>
																</tbody>
															</table>
									...
									<tr>
										<td align=middle bgColor=#9CBFE5 height=25>
											2021 &copy; 小说阅读网站管理系统 All Rights Reserved
										</td>
									</tr>
								</tbody>
							</table>

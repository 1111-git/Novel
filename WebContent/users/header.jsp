...
<div id="Top">
	<div class=" block header_bg">
				...
				<div class="header_r">
					...
					<c:if test="${sessionScope.userid != null }">
						<font id="ECS_MEMBERZONE"> 欢迎光临本站${sessionScope.username }， <a href="index/usercenter.action">[用户中心]</a>&nbsp;<a
							href="index/exit.action">[退出系统]</a> </font>
					</c:if>
				</div>
			</div>
		</div>
		...
		<div class="header_top logo_wrap clearfix">
			<a class="logo_new" href="index.jsp"><img src="themes/xecmoban_shunfeng/images/logo.gif" />
			</a>
			<div class="ser_n">
...
<div class="menu_box clearfix">
	<div class="block">
		<div class="menu">
			...
			<a href="index/article.action" class="cur">新闻公告</a>
			<a href="index/all.action" class="cur">全部小说</a>
